  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="nameRegistration" placeholder="Indiana Johns">
  </div>
  <div class="form-group">
    <label for="passRegistration">Password</label>
    <input type="text" class="form-control" id="passRegistration" placeholder="your super pass">
  </div>
